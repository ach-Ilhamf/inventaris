                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('penyedias.update', $penyedia->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="namaBarang" name="nama"
                                                    placeholder="Nama Penyedia" value="{{ old('penyedia', $penyedia->nama)}}" required>
                                            </div>
                                            <!-- Input untuk Lokasi -->
                                            <div class="mb-3">
                                                <label for="lokasi" class="form-label">Alamat</label>
                                                <input type="text" class="form-control" id="lokasi" name="alamat"
                                                    placeholder="Alamat" value="{{ old('penyedia', $penyedia->alamat)}}" required>
                                            </div>
                                            <div class="mb-3">
